    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        {[
          ...
          { label: "Đã duyệt", value: stats.daPhe, color: "#1565c0" },
          { label: "Đang thực hiện", value: stats.dangTH, color: "#7b1fa2" },
        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex gap-3 px-6 pb-6">
              ...
              <button onClick={handleCreate} className="flex-1 bg-[#0d3b66] text-white px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-[#0a2f52]">Gửi đề xuất</button>
            </div>
          </div>
        </div>
      )}
